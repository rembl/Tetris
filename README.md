# Базовый репозиторий для заданий по курсу Алгоритмы и Структуры Данных

## Готовое приложение

Тетрис поддерживает два режима работы:
1. Классическая игра 
2. Режим решателя (организованный жадным адгоритмом и эвристической функцией)

![Без заголовка](https://user-images.githubusercontent.com/58863120/206291250-083b8b44-e21b-4dba-84b1-533a7e779917.png)
